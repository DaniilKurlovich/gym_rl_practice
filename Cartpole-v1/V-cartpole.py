...
class PlayerAgent:
    ...
    def remember(self, state, reward, terminal, score):
        if self.lower_bound_elite + 0.5 < score:
    ...
    def learn_elite(self):
        ...
        count_batchs = min(25, self.elit_batch_size_start_learn)
        batch = random.sample(self.elit_states, count_batchs)
        ...
        while True:
            ...
            if terminal:
                print("Attempt: " + str(attempt) + ", exploration: "
                      ...
                      agent.lower_bound_elite, ' k: ', agent.k)
                break
